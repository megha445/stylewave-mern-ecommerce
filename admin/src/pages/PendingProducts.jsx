                    ...
                    <div className="mt-3 p-3 bg-gray-50 rounded border border-gray-200">
                      ...
                      <div className="mt-2 flex gap-2">
                        <button
                          ...
                          className="px-4 py-1 bg-red-500 text-white rounded text-sm hover:bg-red-600 transition"
                        >
                          Confirm Reject
                        </button>
                        <button
                          ...
                          className="px-4 py-1 bg-gray-300 text-gray-700 rounded text-sm hover:bg-gray-400 transition"
                        >
                          Cancel
                        </button>
                      </div>
