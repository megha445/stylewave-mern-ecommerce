...
import ProductReviews from '../components/ProductReviews'; // ✅ ADD THIS

const Product = () => {

  const {productId} = useParams();
  const {products, currency, addToCart, backendUrl} = useContext(ShopContext); // ✅ ADD backendUrl
  ...
  <p className='mt-2 text-sm font-semibold text-orange-500'>
    ⚠️ Only {productData.stock} left in stock!
  </p>
)}
{productData.stock === 0 && (
  <p className='mt-2 text-sm font-semibold text-red-600'>
    ❌ Out of Stock
      ...
      {/* ✅ ADD REVIEWS SECTION */}
      <ProductReviews productId={productId} backendUrl={backendUrl} />
